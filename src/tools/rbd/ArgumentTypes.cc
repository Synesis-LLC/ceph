...
void validate(boost::any& v, const std::vector<std::string>& values,
  ...
  uint64_t size = strict_iec_cast<decltype(size)>(s.c_str(), &parse_error);
...
void validate(boost::any& v, const std::vector<std::string>& values,
  ...
  std::string parse_error;
  uint64_t objectsize = strict_iec_cast<decltype(objectsize)>(s.c_str(), &parse_error);
  if (!parse_error.empty()) {
    throw po::validation_error(po::validation_error::invalid_option_value);
  }
...
void validate(boost::any& v, const std::vector<std::string>& values,
  ...
  std::string parse_error;
  uint64_t format = strict_iec_cast<decltype(format)>(s.c_str(), &parse_error);
