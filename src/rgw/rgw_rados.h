...
public:
  ...
  CephContext *ctx() const { return cct; }
  ...
  int delete_obj_index(const rgw_obj& obj, RGWObjState *astate);
  ...
  int cls_user_reset_stats_sync(rgw_raw_obj& obj);
  int user_reset_stats_sync(const rgw_user& user_id);
